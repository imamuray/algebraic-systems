  ...
  \section{第3章 環と多項式}
    ...
    \begin{frame}
      ...
      \begin{defn}
        ...
        $\forall J : \text{left ideal of $R$} \Rightarrow J = R \; \text{or} \; J_L$ $\defarrow$ $J_L$ : $R$の\alert{極大左イデアル(maximal left ideal)}
        $\forall J : \text{right ideal of $R$} \Rightarrow J = R \; \text{or} \; J_R$ $\defarrow$ $J_R$ : $R$の\alert{極大右イデアル(maximal right ideal)}
      \end{defn}
