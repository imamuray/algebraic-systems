  ...
  \section{第3章 環と多項式}
    ...
    \begin{frame}
      ...
      \begin{defn}
        ...
        \end{enumerate}
        $\defarrow$ $J \lideal R$, $J$ : $R$の\alert{左イデアル}
      \end{defn}

      \begin{thm}
        $R$ : 環, $J \subset R, J \neq \emptyset$ \\
        $J \lideal R$ $\Leftrightarrow$ $J \le R$ : 加法部分群, $\forall r \in R, \forall a \in J \Rightarrow ra \in J$
      \end{thm}

      \begin{defn}
        $R$ : 環 \\
        $J \le R$ : 加法部分群, $\forall r \in R, \forall a \in J \Rightarrow ar \in J$ $\defarrow$ $J \rideal R$, $J$ : $R$の\alert{右イデアル}
      \end{defn}
    ...
    \begin{frame}
      ...
      \begin{defn}
        $J \lideal R, J \rideal R$ $\defarrow$ $J \ideal R$, $J$ : $R$の\alert{イデアル}または\alert{両側イデアル}
      \end{defn}
      ...
      \begin{exmText}
        $n \in \mathbb{Z}, n \ge 0$ $\Rightarrow$ $n\mathbb{Z} \ideal \mathbb{Z}$
      \end{exmText}
    ...
    \begin{frame}
      ...
      \begin{defn}
        $J \ideal R, J = \{0\}$ $\defarrow$ $0 \coloneqq J$ : \alert{零イデアル}
      \end{defn}

      \begin{thmText}
        $R$ : 環, $R \neq \emptyset$ \\
        $R$ : 斜体 $\Leftrightarrow$ $\forall J \lideal R \Rightarrow J = R \; \text{or} \; 0$
      \end{thmText}
    ...
    \begin{frame}
      ...
      \begin{thm}
        $n \ge 0, (n) \coloneqq n\mathbb{Z}, (n) \ideal \mathbb{Z}$ ($\because$ \textsection 3 Exm. 2) \\
        $\forall J \ideal \mathbb{Z} \Leftrightarrow \exists n \in \mathbb{Z} \st n \ge 0, J = (n)$
      \end{thm}
    ...
    \begin{frame}
      ...
      \begin{exmText}
        ...
        $c \in [0, 1], F\colon R \to \mathbb{R}, f \mapsto f(c) \Rightarrow F : \hom$
      \end{exmText}
    ...
    \begin{frame}
      ...
      \begin{thm}
        $R, R'$ : 環 \\
        $f\colon R \to R' : \hom \Rightarrow R' \supset f(R) : \text{環}$
      \end{thm}
    ...
    \begin{frame}
      ...
      \begin{defn}
        ...
        $\Ker f \coloneqq \inverse{f}(0)$ : $f$の\alert{核}
      \end{defn}
    ...
    \begin{frame}
      ...
      \begin{thm}
        $R$ : 斜体, $R' \neq \emptyset$ : 環, $f\colon R \to R' : \hom \Rightarrow f : \mon$
      \end{thm}
      ...
      \begin{thmText}
         $R, R'$ : 環, $f\colon R \to R' : \epi, \Ker f = J$
        \begin{itemize}
    ...
    \begin{frame}
      ...
      \begin{lemText}
        $\forall R : \text{ring} \Rightarrow \exists! \mu\colon \mathbb{Z} \to R : \hom \st \mu(n) = n1_R$ 
      \end{lemText}
